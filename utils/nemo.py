...
# Eventually, we may want to solve the above problems or maintain our own fork, since NeMo does have some useful
# big model stuff.


# Copied wholesale from https://github.com/NVIDIA/NeMo/blob/088df4543fc74c82688813e9ad97cf97f04d13ee/nemo/collections/common/callbacks/ema.py
...
# Copied from https://github.com/NVIDIA/NeMo/blob/088df4543fc74c82688813e9ad97cf97f04d13ee/nemo/utils/callbacks/nemo_model_checkpoint.py#L33
# but removed all the NeMo specific stuff. Mostly just handles EMA now.


class ExtendedModelCheckpoint(ModelCheckpoint):
    def _ema_callback(self, trainer: "pytorch_lightning.Trainer") -> Optional[EMACallback]:
        ema_callback = None
